...
@section('content')
    ...
    <section class="contact-section padding-top">
        <div class="contact-container">
            <div class="bg-thumb bg_img" data-background="{{ asset('frontend/images/contact/contact.jpg') }}"></div>
            <div class="container">
                        ...
                        <form class="contact-form" id="contact_form_submit" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" placeholder="Enter Your Phone Number" name="phone" id="phone"
                                    required pattern="[0-9]{10}" title="Phone number must be 10 digits">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="info-area">
                                <div class="info-item">
                                    <div class="info-thumb">
                                        <img src="{{ asset('frontend/images/contact/contact01.png') }}" alt="contact">
                                    </div>
                                ...
                                <div class="info-item">
                                    <div class="info-thumb">
                                        <img src="{{ asset('frontend/images/contact/contact02.png') }}" alt="contact">
                                    </div>
                                    <div class="info-content">
...
<script>
   $(document).ready(function() {
       ...
       handleAjaxFormSubmit('#contact_form_submit', '{{ route('pages.contact.store') }}',
           '{{ route('pages.contact') }}');
   });
</script>
@endpush
